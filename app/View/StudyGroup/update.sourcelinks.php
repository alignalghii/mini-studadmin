		<table class="tree">
			<tr>
				<td rowspan="3" title="POST <?php echo $actionUri; ?>" class="full"><a class="source" href="https://github.com/alignalghii/mini-studadmin/blob/92efdbce271416373b116ec348a40d30e216a2e2/app/Routes.php#L29-L30" target="_blank">Route match</a></td>
				<td rowspan="3">&rarr;</td>
				<td rowspan="3" title="StudyGroupController::update" class="full"><a class="source" href="
https://github.com/alignalghii/mini-studadmin/blob/92efdbce271416373b116ec348a40d30e216a2e2/app/Controller/StudyGroupController.php#L45-L69" target="_blank">Action</a></td>
				<td rowspan="2">&#8599;</td>
			...
			<tr>
				...
				<td colspan="5"></td>
				<td>&#8599;</td>
				<td title="CREATE TABLE `study_group`" class="full"><a class="source" href="https://github.com/alignalghii/mini-studadmin/blob/92efdbce271416373b116ec348a40d30e216a2e2/database/schema/table-create-study_group.sql" target="_blank">SQL schema</a></td>
			</tr>
			<tr>
				<td colspan="4"></td>
