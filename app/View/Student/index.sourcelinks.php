		<table class="tree">
			...
			<tr>
				...
				<td title="Student/index" class="full"><a class="source" href="https://github.com/alignalghii/mini-studadmin/blob/master/app/View/Student/index.php" target="_blank">View</a></td>
				<td colspan="4"></td>
			</tr>
		</table>
